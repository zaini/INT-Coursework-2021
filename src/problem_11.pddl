...
;|  O|   |   |   |   |   
;|   |   |   |   |  O|  O
; A realistic room, with a bed, TV, curved desk, wardrobe
; Roomba returns to initial place which is in the charger, just as you've like it in real life.
...
(define (problem roomba_problem11)
	...
	(:init
		...
		; x5y5 occupied by some obstruction
